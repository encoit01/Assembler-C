...
;
;   Co-Author:  Enes Coskunyürek, Tolgahan Kandemir
...
TIMER_ON    equ $80             ; tscr1 value to turn ECT on  | Bug_1: TIMER_ON must set to 0x80
...
initTicker:
        ...
        ldab TSCR2
        andb #$f8
        orab #7                 ; Error: this must be turned into 7 | Bug_2: Set this to 7 instead 8
        stab TSCR2
...
isrECT4:
        ...
        ldab #$01              ; In this example we let blink the LED on port B.0 (every 1s)
        JSR toggleLED
        ;eorb #$01               ;
        ;stab PORTB              ;        

        ldab clockEvent         ; set the clockEvent to 1 to signal that one second has been reached
        addb #1                 ;
        stab clockEvent         ;
